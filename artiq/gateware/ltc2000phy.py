...
class Ltc2000phy(Module, AutoCSR):
    def __init__(self, pads):
        self.data_in = Signal(16*2*6) # 16 bits per channel, 2 channels, 6 bits per bit, data coming in at sys2x rate => for 100 MHz sysclk we get 200 MHz * 2 * 6 = 2.4 Gbps
        self.reset = Signal()
        ...
        self.specials += [
            Instance("OSERDESE2",
                ...
                i_OCE=1,
                i_RST=self.reset,
                i_CLK=ClockSignal("sys3x"), i_CLKDIV=ClockSignal("sys2x"),
