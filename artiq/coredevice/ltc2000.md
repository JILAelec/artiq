...
| **b1** | TInt32 | 16 bits | First derivative coefficient |
...
The function packs coefficients into a 224-bit data structure sent to the hardware:

```
Bit Range    | Content              | Source
[15:0]       | Amplitude offset     | b0 & 0xFFFF
[31:16]      | First derivative     | b1 & 0xFFFF
[43:32]      | Reserved             | 0 (12 bits)
[47:44]      | Shift factor         | shift & 0xF
...
- `b1` must fit in 16 bits signed range [-32768, 32767]
